...
-(UIImage*)resourcesName:(NSString *)name
{
    NSString *normalImgName = [NSString stringWithFormat:@"%@@2x.png", name];
    NSBundle *curBundle = [NSBundle bundleForClass:self.class]; // 获取当前bundle
    NSString *normalImgPath = [curBundle pathForResource:normalImgName ofType:nil inDirectory:@"YSMainAlert.bundle"];
...
//        UIImage *image = [UIImage imageWithContentsOfFile:imgPath];
        UIImage *image = [self resourcesName:@"close"];
